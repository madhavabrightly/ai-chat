...
def get_compute_status() -> dict:
    ...
    status = {
        ...
        "avatar_action_model": AVATAR_ACTION_MODEL_ID,
        "avatar_action": "ModelScope Qwen3" if _avatar_action_ready() else "Instant motion rules",
        "avatar": "Three.js procedural GLB",
        "llm": LLM_MODEL_NAME,
        "embedding": EMBEDDING_MODEL_NAME,
        "tts": TTS_MODEL_ID,
        "asr": ASR_MODEL_ID,
        "model_root": MODEL_ROOT,
        "model_cache_path": MODEL_ROOT,
...
def _avatar_action_ready() -> bool:
    try:
        from backend.models.avatar_action_loader import avatar_action_model_ready
        return avatar_action_model_ready()
    except Exception:
        return False
