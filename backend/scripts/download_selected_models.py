...
DOWNLOAD_ORDER = ["embedding", "avatar_action", "tts", "asr", "llm", "avatar_video"]
...
def download_selected_models():
    ...
    for key in download_list:
        ...
        try:
            print(f"  Downloading...")
            local_path = snapshot_download(model_id=model_id, local_dir=target_dir)
