...
MODEL_SPECS = {
    ...
    "avatar_action": {
        "id": "Qwen/Qwen3-0.6B",
        "preferred_dir": os.path.join(MODEL_ROOT, "qwen3_avatar_action"),
        "legacy_dirs": [os.path.join(MODEL_ROOT, "Qwen_Qwen3-0.6B")],
        "purpose": "Low-latency structured avatar gesture direction",
        "size_gb": 1.6,
    },
}
...
def get_model_status() -> dict:
    ...
    for key, spec in MODEL_SPECS.items():
        ...
        if key == "asr" and not has_weights:
            ...
            fallback = "procedural_glb_avatar"
        elif key == "avatar_action" and not has_weights:
            fallback = "instant_rule_director"
